...
const MySkills = () => {
  ...
  return (
    <section id="skills" className="pt-10 pb-12">
      ...
      <div className="md:flex md:justify-between md:gap-16 mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7">
            My top three skills include React JS using MUI design library, React Native and MERN
            full stack apps.
          </p>
        </motion.div>
      ...
      {/* SKILLS */}
      <div className="md:flex md:justify-between mt-16 gap-24">
        {/* EXPERIENCE */}
        <motion.div
        ...
        >
          <div className="relative h-32">
            <div className="z-10">
              ...
              <p className="font-playfair font-semibold text-3xl mt-3">MERN FullStack</p>
            </div>
